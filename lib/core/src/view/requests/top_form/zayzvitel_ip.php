...
<div class="form__row form__row_double align-center">
    ...
    <div class="form__col">
        <input type="text" class="form__field-input required" value="ИП" disabled>
    </div>
</div>
...
<div class="form__row form__row_double align-center">
    ...
    <div class="form__col">
        <input type="text" class="form__field-input" value="<?=trim($urAddr['WORK_CITY_2'])?>" disabled>
    </div>
</div>
<div class="form__row form__row_double align-center">
    <div class="form__col">
...
<div class="form__row form__row_double align-center">
    ...
    <div class="form__col">
        <input type="text" class="form__field-input required" value="<?=($userInfo['UF_GRNIP'])?>" disabled>
    </div>
</div>
<div class="form__row form__row_double align-center">
    <div class="form__col">
