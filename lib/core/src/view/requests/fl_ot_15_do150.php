...
<!--            </p>-->
    ...
    <div class="form__row form__row_double align-center">
        ...
        <div class="form__col">
            <input type="number"   class="form__field-input required" name="MAX_POWER_CONNECT" required value="" step="0.01">
        </div>
    </div>
    ...
    <div class="form__row form__row_double align-center" style="display: none" data-target="REQUEST_REASONS[]" data-val="3,4,5,6">
        ...
        <div class="form__col">
            <input type="number" class="form__field-input required" name="MAX_BEFORE_POWER_B"  value="" step="0.01">
        </div>
    </div>
    <!--
...
<!--    </div>-->
    ...
    <div class="form__row form__row_double align-center">
        ...
        <div class="form__col">
            <input type="number"  class="dis form__field-input required MAX_POWER_EN_GET_DEVICE"
                   name="MAX_POWER_EN_GET_DEVICE[]" value="" step="0.01" max="150" min="15.01">
        </div>
    </div>
    ...
    <div class="form__row form__row_double align-center">
        ...
        <div class="form__col">
            <div class="dropdown js-dropdown EN_GET_DEVICE_BEFORE_POWER_B dis">
    ...
    <div class="form__row form__row_double align-center">
        ...
        <div class="form__col">
            ...
            <div class="dropdown js-dropdown ">
                ...
                <div class="dropdown__title"></div>
                <div class="dropdown__list">
                    <div data-id="1" class="dropdown__item active"></div>
                    <div data-id="2" class="dropdown__item">
                        2
                    </div>
                    <div data-id="3" class="dropdown__item">
