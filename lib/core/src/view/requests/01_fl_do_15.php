...
<form class="form form_request" method="post" action="" enctype="multipart/form-data" id="city_zayvka_form">
    ...
    <!--   REQUEST_REASONS  style="display: none" data-target="REQUEST_REASONS[]" data-val="1" -->
    <div>
        <div class="form__row form__row_double align-center">
            ...
            <div class="form__col">
                <div class="dropdown js-dropdown">
                    <input type="hidden" name="CONNECT_SCHEMA" class="dropdown__input" value="">
        ...
        <div>
            <div class="form__row form__row_double align-center js_show_if" style="display: none" data-target="CONNECT_SCHEMA" data-val="2">
                <div class="form__col">
                    <div class="form__field-label">
                        По временной схеме на период: с<br/>
                        <i>
    ...
    <div class="form__row form__row_double align-center" id="REQUEST_REASONS_list">
        <div class="form__col">
            <div class="form__field-label">
        ...
        <div class="form__col">
<!--            <p>-->
<!--                <input class="checkbox_f" type="checkbox" name="REQUEST_REASONS[]" data-id="1" value="Подключение к электрической сети с электроснабжением">-->
<!--                <span>Подключение к электрической сети с электроснабжением</span>-->
<!--            </p>-->
            <p>
...
<!--
ceb97ad4-b9ef-449e-bdad-b49b89ed83d0
ключ яндекс апи
-->
    ...
    <div class="form__row form__row_double align-center">
        ...
        <div class="form__col">
            <input type="number" min="0" max="15" class="form__field-input required" name="MAX_POWER_CONNECT" required value="" step="0.01">
        </div>
    </div>
    ...
    <div class="form__row form__row_double align-center">
        ...
        <div class="form__col">
            <div class="dropdown js-dropdown MAX_POWER_CONNECT">
...
Если в предыдущем поле значение до 7 кВт включительно, то варианты для выбора:
1. 0,22 кВ
2. 0,4 кВ

А если от 7 до 15
То только 1 вариант, и его сразу отмечаем
1. 0,4 кВ
...
-->
    ...
    <div class="form__row form__row_double align-center" style="display: none" data-target="REQUEST_REASONS[]" data-val="3,4,5,6">
        <div class="form__col">
            <div class="form__field-label">
                Ранее присоединенная мощность, кВт  <br/>
                <i>
                    (укажите данные из договора энергоснабжения)
                </i>
            </div>
        </div>
        <div class="form__col">
            <input type="number" min="0" max="15" class="form__field-input required" name="MAX_BEFORE_POWER_B"  value="" step="0.01">

        </div>
    </div>
<!--

Это поле по умолчанию должно быть задисейблено и отображается только если в поле “причина обращения” отмечен хотя бы 1 из этих вариантов: 3,4,5,6
Под полем добавить примечание: “Укажите данные из договора энергоснабжения”

-->

    <div class="form__row form__row_double align-center" style="display: none"
         data-target="REQUEST_REASONS[]" data-val="3,4,5,6">
        <div class="form__col">
            <div class="form__field-label">
                при напряжении, кВ
                <br/>
...
Если в поле “Ранее присоединённая максимальная мощность” стоит число отличное от нуля, то выводим дополнительные поля для ввода реквизитов договора.
Выводим заголовок “Реквизиты договора энергоснабжения” и под ним 2 поля:
«Дата договора» - календарь, «Номер договора» - инпут.



-->
<!--<div style="display: none" data-target="MAX_BEFORE_POWER_B">-->
<!--    <div class="form__row">-->
<!--        <div class="form__col form__col_full">-->
<!--            <div class="seconfary-title form__row_title">-->
<!--                Реквизиты договора энергоснабжения-->
...
<!--</div>-->
    ...
    <div class="form__row form__row_double align-center">
        <div class="form__col">
            <div class="form__field-label">
                Максимальная (суммарная) мощность энергопринимающих устройств объекта, кВт
            </div>
        </div>
        <div class="form__col">
            <input type="number" max="15" class="form__field-input dis required MAX_POWER_EN_GET_DEVICE" name="MAX_POWER_EN_GET_DEVICE[]" value="" step="0.01">
        </div>
    </div>
<!--    Рассчитывается автоматически, как сумма присоединенной и присоединяемой.
Проверять, чтобы была не больше 15 кВт. Иначе писать ошибку “Максимальная мощность не может превышать 15 кВт”
-->
    ...
    <div class="form__row form__row_double align-center">
        ...
        <div class="form__col">
            <div class="dropdown js-dropdown EN_GET_DEVICE_BEFORE_POWER_B dis" style="overflow: hidden;">
                <input type="hidden" name="EN_GET_DEVICE_BEFORE_POWER_B" class="dropdown__input" value="0,22" >
                <div class="dropdown__title">0,22</div>
                <div class="dropdown__list">
                    <div data-id="1" class="dropdown__item active">
                        0,22
...
<!--    Если в предыдущем поле до 7 кВт включительно, то отображаются варианты напряжения
·         0,22 кВ
·         0,4 кВ
А если от 7 до 15, то только
·         0,4 кВ
...
-->
    ...
    <div class="form__row form__row_double align-center">
        ...
        <div class="form__col">
            <div class="form__field">
                <div class="form__field-row">
                    <input type="text" class="form__field-input dis" name="ZAY_CAT_NAD" value="3" >
                </div>
            </div>
        </div>
    </div>

    <div class="form__row form__row_double align-center" data-target="REQUEST_REASONS[]" data-val="3,4,5,6" style="display: none">
...
-->
    ...
    <div class="form__row form__row_double align-center" data-target="REQUEST_REASONS[]" data-val="3,4,5,6" style="display: none">
        ...
        <div class="form__col form__col_full">
            <div class="form__field">
                <div class="form__field-row">
                    <input type="text" class="form__field-input " name="R_V_TECH_USLOV_LITS" value="">
                </div>
            </div>
        </div>
    </div>
